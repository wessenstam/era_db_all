...
.. toctree::
   :maxdepth: 3
   :caption: Appendix
   :name: _appendix_postgress
   :hidden:

   appendix/glossary

.. _getting_started_postgress:

---------------
Getting Started
---------------

Welcome to the Databases: Era with Postgres part of the NEEUR Bootcamp! This workbook accompanies an instructor-led session that introduces Nutanix technologies and many common management tasks.
