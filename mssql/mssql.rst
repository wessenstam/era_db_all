...
.. _getting_started_mssql:

---------------
Getting Started
---------------

Welcome to the Databases: Era with MSSQL part of the NEEUR Bootcamp! This workbook accompanies an instructor-led session that introduces Nutanix technologies and many common management tasks.
